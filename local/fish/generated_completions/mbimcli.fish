...
complete -c mbimcli -l query-provisioned-contexts --description 'Query provisioned contexts . SS "Phonebook options:".'
...
complete -c mbimcli -l phonebook-delete-all --description 'Delete all phonebook entries . SS "Device Service Stream options:".'
complete -c mbimcli -l dss-connect --description 'Connect DSS session.'
complete -c mbimcli -l dss-disconnect --description 'Disconnect DSS session . SS "Microsoft Firmware ID options:".'
complete -c mbimcli -l ms-query-firmware-id --description 'Query firmware ID . SS "Microsoft Host Shutdown options:".'
complete -c mbimcli -l ms-notify-host-shutdown --description 'Notify that host is shutting down . SS "AT&T Device Service options:".'
complete -c mbimcli -l atds-query-signal --description 'Query signal info.'
complete -c mbimcli -l atds-query-location --description 'Query cell location . SS "Intel Firmware Update Service options:".'
complete -c mbimcli -l intel-modem-reboot --description 'Reboot modem . SS "Microsoft Basic Connect Extensions options:".'
...
complete -c mbimcli -s V -l version --description 'Print version COPYRIGHT Copyright © 2013-2020 Aleksander Morgado License GPLv…'
