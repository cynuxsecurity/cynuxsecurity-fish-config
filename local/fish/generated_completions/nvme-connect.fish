# nvme-connect
# Autogenerated from man page /usr/lib/jvm/default/man/man1/nvme-connect.1.gz
...
complete -c nvme-connect -s D -l duplicate-connect -d 'Allows duplicated connections between same trnsport host and subsystem port'
