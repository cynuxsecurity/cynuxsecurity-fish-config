# pr
# Autogenerated from man page /usr/lib/jvm/default/man/man1/pr.1.gz
...
complete -c pr -l version --description 'output version information and exit AUTHOR Written by Pete TerMaat and Roland…'
