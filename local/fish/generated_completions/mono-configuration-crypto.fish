...
# Autogenerated from man page /usr/lib/jvm/default/man/man1/mono-configuration-crypto.1.gz
...
complete -c mono-configuration-crypto -s r -l remove --description 'Remove a container.  Physically removes the container file from disk.'
