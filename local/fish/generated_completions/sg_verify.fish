# sg_verify
# Autogenerated from man page /usr/lib/jvm/default/man/man8/sg_verify.8.gz
complete -c sg_verify -s 0 -l 0 --description 'a buffer NDO bytes long full of zeros is sent as the data-out part of a VERIF…'
...
complete -c sg_verify -s f -l ff --description 'a buffer NDO bytes long full of 0xff bytes is sent as the data-out part of a …'
