...
complete -c pcre2grep -s m -l max-count --description 'Stop processing after finding number matching lines, or non-matching lines if…'
...
complete -c pcre2grep -s O -l output --description 'When there is a match, instead of outputting the line that matched, output ju…'
...
complete -c pcre2grep -l recursion-limit --description 'This is an obsolete synonym for --depth-limit.'
