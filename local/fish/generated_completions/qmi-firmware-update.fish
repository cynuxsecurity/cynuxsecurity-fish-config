# qmi-firmware-update
# Autogenerated from man page /usr/lib/jvm/default/man/man1/qmi-firmware-update.1.gz
...
complete -c qmi-firmware-update -s b -l reset --description 'Reset device into download mode. SS "Update options (download mode):".'
