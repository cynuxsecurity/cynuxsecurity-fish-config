# pg_receivewal
# Autogenerated from man page /usr/lib/jvm/default/man/man1/pg_receivewal.1.gz
complete -c pg_receivewal -s D --description 'Directory to write the output to. sp This parameter is required.'
complete -c pg_receivewal -s E --description 'Automatically stop replication and exit with normal exit status 0 when receiv…'
...
complete -c pg_receivewal -l no-sync --description 'This option causes pg_receivewal to not force WAL data to be flushed to disk.'
...
complete -c pg_receivewal -s d --description 'Specifies parameters used to connect to the server, as a connction string; th…'
...
complete -c pg_receivewal -s n --description 'parameter.'
complete -c pg_receivewal -l directory --description '.'
complete -c pg_receivewal -l endpos --description '.'
