...
complete -c ethtool -s I -l include-statistics --description 'Include command-related statistics in the output.'
...
complete -c ethtool -l show-tunnels --description 'Show tunnel-related device capabilities and state.'
