# hwloc-calc
# Autogenerated from man page /usr/lib/jvm/default/man/man1/hwloc-calc.1.gz
...
complete -c hwloc-calc -l local-memory --description 'Report the list of NUMA nodes that are local to the input objects.'
complete -c hwloc-calc -l local-memory-flags --description 'Change the flags used to select local NUMA nodes.'
complete -c hwloc-calc -l best-memattr --description 'Enable the listing of local memory nodes with --local-memory, but only displa…'
