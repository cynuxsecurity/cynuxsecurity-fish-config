...
complete -c wvunpack -l normalize-floats --description 'normalize float audio to +/-1.'
...
complete -c wvunpack -o vv --description 'quick verify (no output, version 5+ files only).'
