# xorrecord
# Autogenerated from man page /usr/lib/jvm/default/man/man1/xorrecord.1.gz
...
complete -c xorrecord -l grow_overwriteable_iso --description 'Enable emulation of multi-session writing on overwritable media which contain…'
