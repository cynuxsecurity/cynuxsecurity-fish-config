...
complete -c git-rev-list -l disk-usage --description 'Suppress normal output; instead, print the sum of the bytes used for on-disk …'
...
complete -c git-rev-list -l unfold --description 'option was given.  E. g.'
