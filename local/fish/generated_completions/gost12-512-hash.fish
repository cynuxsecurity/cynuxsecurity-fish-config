# gost12-512-hash
# Autogenerated from man page /usr/lib/jvm/default/man/man1/gost12-512-hash.1.gz
...
complete -c gost12-512-hash -l blake2b -l blake2s --description 'BLAKE2: Select BLAKE2b/BLAKE2s hash function.'
...
complete -c gost12-512-hash -l follow --description 'Follow symbolic links when processing files or directories recursively.'
...
complete -c gost12-512-hash -l no-detect-by-ext --description 'Disable hash function detection from a hash file extension in the --check mod…'
