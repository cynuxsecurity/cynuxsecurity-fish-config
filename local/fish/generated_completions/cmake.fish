...
complete -c cmake -l preset -d 'Reads a preset from <path-to-source>/CMakePresets'
complete -c cmake -l build -d 'Project binary directory to be built.   This is required and must be first'
