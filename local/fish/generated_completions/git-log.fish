...
complete -c git-log -l diff-merges --description 'for details.'
...
complete -c git-log -l unfold --description 'option was given.  E. g.'
complete -c git-log -s p -s u --description '.'
complete -c git-log -s s --description '.'
complete -c git-log -l no-diff-merges --description '.'
...
complete -c git-log -l skip-to -l rotate-to --description '.'
