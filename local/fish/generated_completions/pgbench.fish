...
complete -c pgbench -s b -d 'Add the specified built-in script to the list of executed scripts'
...
complete -c pgbench -s f -d 'Add a transaction script read from filename to the list of executed scripts'
