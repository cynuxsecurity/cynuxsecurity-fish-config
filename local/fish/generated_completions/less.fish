...
complete -c less -o kfilename -l lesskey-file --description 'Causes  less to open and interpret the named file as a R lesskey (1) file.'
...
complete -c less -l MOUSE --description 'Like --mouse, except the direction scrolled on mouse wheel movement is revers…'
...
complete -c less -s t --description 'use of tags files metacharacters in filenames, such as * filename completion …'
