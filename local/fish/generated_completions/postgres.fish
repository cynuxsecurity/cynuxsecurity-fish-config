# postgres
# Autogenerated from man page /usr/lib/jvm/default/man/man1/postgres.1.gz
...
complete -c postgres -s S --description 'Specifies the base amount of memory to be used by sorts and hash tables befor…'
