...
complete -c cryptsetup -l type --description 'Specifies required device type, for more info read BASIC ACTIONS section.'
...
complete -c cryptsetup -l help -s '?' --description 'Show help text and default parameters.  EXAMPLE.'
