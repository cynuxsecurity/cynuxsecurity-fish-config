...
complete -c cryptsetup -l type -d 'Specifies required device type, for more info read BASIC COMMANDS section'
...
complete -c cryptsetup -l no_write_workqueue -d 'and --allow-discards'
...
complete -c cryptsetup -l help -s '?' -d 'Show help text and default parameters'
