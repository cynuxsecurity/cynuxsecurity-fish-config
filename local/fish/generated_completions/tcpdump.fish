# tcpdump
# Autogenerated from man page /usr/lib/jvm/default/man/man1/tcpdump.1.gz
...
complete -c tcpdump -l count --description 'Print only on stderr the packet count when reading capture file(s) instead of…'
...
complete -c tcpdump -l interface --description 'PD Listen, report the list of link-layer types, report the list of time stamp…'
...
complete -c tcpdump -l nano --description 'PD Shorthands for --time-stamp-precision=micro or --time-stamp-precision=nano…'
...
complete -c tcpdump -l print --description 'Print parsed packet output, even if the raw packets are being saved to a file…'
...
complete -c tcpdump -o ttt --description 'Print a delta (microsecond or nanosecond resolution depending on the  --time-…'
complete -c tcpdump -o tttt --description 'Print a timestamp, as hours, minutes, seconds, and fractions of a second sinc…'
complete -c tcpdump -o ttttt --description 'Print a delta (microsecond or nanosecond resolution depending on the  --time-…'
complete -c tcpdump -s u --description 'Print undecoded NFS handles.'
complete -c tcpdump -l packet-buffered --description 'PD If the  -w option is not specified, or if it is specified but the  --print…'
...
complete -c tcpdump -s X --description 'When parsing and printing, in addition to printing the headers of each packet…'
complete -c tcpdump -o XX --description 'When parsing and printing, in addition to printing the headers of each packet…'
complete -c tcpdump -l linktype --description 'PD Set the data link type to use while capturing packets (see  -L ) or just c…'
...
complete -c tcpdump -s i --description 'or the particular DLT of the network interface specified with.'
complete -c tcpdump -s y --description 'and.'
...
complete -c tcpdump -s J --description '.'
complete -c tcpdump -l micro --description '.'
