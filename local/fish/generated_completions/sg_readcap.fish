# sg_readcap
# Autogenerated from man page /usr/lib/jvm/default/man/man8/sg_readcap.8.gz
...
complete -c sg_readcap -s z -l zbc --description 'additionally prints out the extra ZBC field (RC_BASIS) in the READ CAPACITY r…'
