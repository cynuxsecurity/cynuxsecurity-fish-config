# nbd-client
# Autogenerated from man page /usr/lib/jvm/default/man/man8/nbd-client.8.gz
...
complete -c nbd-client -o preinit --description '.'
complete -c nbd-client -s P --description 'When this option is specified, nbd-client will skip the usual negotiation wit…'
complete -c nbd-client -o readonly --description '.'
complete -c nbd-client -s R --description 'When this option is specified, nbd-client will tell the kernel to treat the d…'
complete -c nbd-client -o size --description '.'
complete -c nbd-client -s B --description 'Force the device size to the specified number of bytes, rather than using the…'
