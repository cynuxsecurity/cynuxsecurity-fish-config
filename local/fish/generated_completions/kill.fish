# kill
# Autogenerated from man page /usr/lib/jvm/default/man/man1/kill.1.gz
...
complete -c kill -s q -l queue --description 'Send the signal using  sigqueue (3) rather than  kill (2).'
complete -c kill -l timeout --description 'Send a signal defined in the usual way to a process, followed by an additiona…'
