...
complete -c git-diff-tree -l skip-to -l rotate-to --description 'Discard the files before the named <file> from the output (i. e.'
...
complete -c git-diff-tree -l unfold --description 'option was given.  E. g.'
