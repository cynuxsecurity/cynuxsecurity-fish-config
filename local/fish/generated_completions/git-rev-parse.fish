...
complete -c git-rev-parse -l path-format --description 'Controls the behavior of certain other options.'
...
complete -c git-rev-parse -l show-toplevel --description 'Show the (by default, absolute) path of the top-level directory of the workin…'
